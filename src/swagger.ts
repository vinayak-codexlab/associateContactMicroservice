...
export const swaggerSpec = {
  ...
  info: {
    ...
    version: "1.0.0",
    description:
      "Swagger documentation for the contact association endpoints. Use Try it out to execute requests directly from the browser. Click Authorize and paste a Bearer token, or keep using the accessToken cookie. If your client sends user_token instead, the API accepts that cookie name too.",
  },
  servers: [{ url: "/", description: "Local server" }],
  tags: [
    {
      name: "Contact Associations",
      description: "Manage broker contact associations",
    },
  ],
  paths: {
    "/v1/user/listing/": {
      post: {
        ...
        requestBody: {
          ...
          content: {
            "application/json": {
              schema: {
                $ref: "#/components/schemas/CreateContactAssociationRequest",
              },
              example: {
                contacts: [
                  {
        ...
        responses: {
          201: {
            description: "Contact association created successfully",
            content: {
              "application/json": {
                schema: {
                  $ref: "#/components/schemas/CreateContactAssociationResponse",
                },
              },
            },
          },
    ...
    "/v1/user/listing/{listingId}": {
      get: {
        ...
        responses: {
          200: {
            description: "List of contact associations",
            content: {
              "application/json": {
                schema: {
                  $ref: "#/components/schemas/ListContactAssociationsResponse",
                },
              },
            },
          },
    ...
    "/v1/user/listing/{id}": {
      delete: {
        ...
        responses: {
          200: {
            description: "Contact association deleted successfully",
            content: {
              "application/json": {
                schema: {
                  $ref: "#/components/schemas/DeleteContactAssociationResponse",
                },
              },
            },
          },
        ...
        responses: {
          200: {
            ...
            content: {
              "application/json": {
                schema: {
                  $ref: "#/components/schemas/UpdateContactTypeResponse",
                },
              },
            },
          },
        ...
        responses: {
          200: {
            ...
            content: {
              "application/json": {
                schema: {
                  $ref: "#/components/schemas/UpdateContactDataResponse",
                },
              },
            },
          },
    ...
    schemas: {
      ContactAssociation: {
        ...
        properties: {
          ...
          source: {
            type: "string",
            enum: ["manual", "import", "rezideContact"],
          },
